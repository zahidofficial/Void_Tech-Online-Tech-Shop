...
public class RTX3090Details extends JFrame{
	private JButton increaseQuantity, decreaseQuantity, buyNowButton, backButton;
	private Container c;
	private Cursor cursor;
	int valueInt=1, price = 198000, fileNo, fileIs;
	...
	RTX3090Details(){
		...
		ImageIcon Newpass_Background = new ImageIcon("Images\\RTX 3090 Ti Details.png");
