...
public class COREI5Details extends JFrame{
	private JButton increaseQuantity, decreaseQuantity, buyNowButton, backButton;
	private Container c;
	private Cursor cursor;
	int valueInt=1, price = 34200, fileNo, fileIs;
	...
	COREI5Details(){
		...
		backButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent a){
				...
				try{
					...
					System.out.println("COREI5Details panel gui call problem");
				}
			}
			});
		...
		ImageIcon Newpass_Background = new ImageIcon("Images\\INTEL CORE i5-12600K Details.png");
