...
public class AORUSMASTEROrderPlace extends JFrame{
	
	//Component Name & Price
	double price = 52500, shipping = 40;
	String ProductName = "X670E_AORUS_MASTER";
	//------------------------------------------------------
		...
		backButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent a){
				...
				try{
					...
					System.out.println("AORUSMASTEROrderPlace panel gui call problem");
				}
			}
			});
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		ImageIcon Newpass_Background = new ImageIcon("Images\\X670E AORUS MASTER PlaceOrder.png");
