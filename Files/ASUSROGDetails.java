...
public class ASUSROGDetails extends JFrame{
	private JButton increaseQuantity, decreaseQuantity, buyNowButton, backButton;
	private Container c;
	private Cursor cursor;
	int valueInt=1, price = 76300, fileNo, fileIs;
	...
	ASUSROGDetails(){
		...
		backButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent a){
				...
				try{
					...
					System.out.println("ASUSROGDetails panel gui call problem");
				}
			}
			});
		...
		ImageIcon Newpass_Background = new ImageIcon("Images\\ASUS ROG MAXIMUS Z690 Details.png");
