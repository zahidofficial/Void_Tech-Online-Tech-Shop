...
public class RTX3090OrderPlace extends JFrame{
	
	//Component Name & Price
	double price = 198000, shipping = 50;
	String ProductName = "GeForce_RTX_3090_Ti_Gaming_X_Trio_24G";
	//------------------------------------------------------
		...
		backButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent a){
				...
				try{
					...
					System.out.println("RTX3090Details panel gui call problem");
				}
			}
			});
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		ImageIcon Newpass_Background = new ImageIcon("Images\\RTX 3090 Ti PlaceOrder.png");
