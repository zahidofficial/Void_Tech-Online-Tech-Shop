...
public class COREI9OrderPlace extends JFrame{
	
	//Component Name & Price
	double price = 69000, shipping = 30;
	String ProductName = "INTEL_CORE_i9-12900K";
	//------------------------------------------------------
		...
		backButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent a){
				...
				try{
					...
					System.out.println("COREI9OrderPlace panel gui call problem");
				}
			}
			});
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		ImageIcon Newpass_Background = new ImageIcon("Images\\INTEL CORE i9-12900K PlaceOrder.png");
