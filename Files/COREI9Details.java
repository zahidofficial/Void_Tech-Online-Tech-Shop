...
public class COREI9Details extends JFrame{
	private JButton increaseQuantity, decreaseQuantity, buyNowButton, backButton;
	private Container c;
	private Cursor cursor;
	int valueInt=1, price = 69000, fileNo, fileIs;
	...
	COREI9Details(){
		...
		backButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent a){
				...
				try{
					...
					System.out.println("INTEL CORE i9-12700K Details panel gui call problem");
				}
			}
			});
		...
		ImageIcon Newpass_Background = new ImageIcon("Images\\INTEL CORE i9-12900K Details.png");
