...
public class RTX2080Details extends JFrame{
	private JButton increaseQuantity, decreaseQuantity, buyNowButton, backButton;
	private Container c;
	private Cursor cursor;
	int valueInt=1, price = 138500, fileNo, fileIs;
	...
	RTX2080Details(){
		...
		ImageIcon Newpass_Background = new ImageIcon("Images\\RTX 2080 Ti Details.png");
