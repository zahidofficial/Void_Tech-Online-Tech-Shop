...
public class MSIMEGOrderPlace extends JFrame{
	
	//Component Name & Price
	double price = 78400, shipping = 40;
	String ProductName = "MSI_MEG_Z690_ACE";
	//------------------------------------------------------
		...
		backButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent a){
				...
				try{
					...
					System.out.println("MSIMEGOrderPlace panel gui call problem");
				}
			}
			});
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		ImageIcon Newpass_Background = new ImageIcon("Images\\MSI MEG Z690 ACE PlaceOrder.png");
