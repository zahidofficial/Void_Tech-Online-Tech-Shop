...
public class COREI5OrderPlace extends JFrame{
	
	//Component Name & Price
	double price = 34200, shipping = 30;
	String ProductName = "INTEL_CORE_i5-12600K";
	//------------------------------------------------------
		...
		backButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent a){
				...
				try{
					...
					System.out.println("COREI5OrderPlace panel gui call problem");
				}
			}
			});
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		ImageIcon Newpass_Background = new ImageIcon("Images\\INTEL CORE i5-12600K PlaceOrder.png");
