...
public class COREI7Details extends JFrame{
	private JButton increaseQuantity, decreaseQuantity, buyNowButton, backButton;
	private Container c;
	private Cursor cursor;
	int valueInt=1, price = 47000, fileNo, fileIs;
	...
	COREI7Details(){
		...
		backButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent a){
				...
				try{
					...
					System.out.println("INTEL CORE i7-12900K Details panel gui call problem");
				}
			}
			});
		...
		ImageIcon Newpass_Background = new ImageIcon("Images\\INTEL CORE i7-12700K Details.png");
