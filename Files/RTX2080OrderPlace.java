...
public class RTX2080OrderPlace extends JFrame{
	
	//Component Name & Price
	double price = 138500, shipping = 50;
	String ProductName = "MSI_GeForce_RTX_2080_Ti_Gaming_X_Trio";
	//------------------------------------------------------
		...
		backButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent a){
				...
				try{
					...
					System.out.println("RTX2080Details panel gui call problem");
				}
			}
			});
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		ImageIcon Newpass_Background = new ImageIcon("Images\\RTX 2080 Ti PlaceOrder.png");
