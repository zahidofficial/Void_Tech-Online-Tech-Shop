...
public class AORUSMASTERDetails extends JFrame{
	private JButton increaseQuantity, decreaseQuantity, buyNowButton, backButton;
	private Container c;
	private Cursor cursor;
	int valueInt=1, price = 52500, fileNo, fileIs;
	...
	AORUSMASTERDetails(){
		...
		backButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent a){
				...
				try{
					...
					System.out.println("AORUSMASTERDetails panel gui call problem");
				}
			}
			});
		...
		ImageIcon Newpass_Background = new ImageIcon("Images\\X670E AORUS MASTER Details.png");
